...
In addition to the 19 previous first order regions, RGI 7.0 defines a new first order region (`20`, Antarctic Mainland) and one associated second order region (`20-01`, Antarctic Mainland). This region currently contains no glaciers.
...
- A new region `20`, ("*Antarctic Mainland*") has been added but it presently contains no glaciers in the RGI.
