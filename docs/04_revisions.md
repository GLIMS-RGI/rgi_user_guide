...
5. **Generation of RGI 7.0**: The RGI steering committee approved the RGI 7.0 dataset on August 23rd, 2023. The glacier outlines are extracted from the GLIMS database downloaded from the NSIDC-DAAC servers on May 24th, 2023. The final RGI 7.0 dataset was created by renaming the beta files and storing them in a permanent repository on September 20th, 2023.
