...
All previous outlines have been replaced by the GAMDAM inventory version 2 {cite:p}`Sakai2019` except for the Khumbu region where we use data by Tobias Bolch.
